! function(t, e, i, n) {
    ...
    function s() {
        $(".slider--prev, .slider--next").click(function() {
            var parent = $(this).parent().find(".slider").get(0);
            var t = $(this),
                e = $(parent).find(".slider--item-left"),
                i = $(parent).children().index(e),
                n = $(parent).find(".slider--item-center"),
                s = $(parent).children().index(n),
                r = $(parent).find(".slider--item-right"),
                o = $(parent).children().index(r),
                a = $(parent).children().length,
                l = $(parent).find(".slider--item-left"),
                c = $(parent).find(".slider--item-center"),
                h = $(parent).find(".slider--item-right"),
                u = $(parent).find(".slider--item");
            $(parent).animate({
                opacity: 0
